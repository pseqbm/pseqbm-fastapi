...
#import Base object from models.py so we can use models (even thought this object was initialized inside database.py)
from app.models import Base
#access all of our environment variables
